document.addEventListener("DOMContentLoaded", function () {
    ...
    submenuItem.innerHTML = `
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item subsub" href="//costalab.github.io/CrossTalkeR/articles/HumanFibrosis.html">Intercellular Communication Analysis</a></li>
        ...
        <li><a class="dropdown-item subsub" href="//costalab.github.io/CrossTalkeR/articles/ProgenyLRExample.html">Progeny Ligand-Receptor Enrichment</a></li>
      </ul>
    `;
