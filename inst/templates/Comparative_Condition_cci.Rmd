...
*Here, for each comparison we perform a differencial interaction test using Fisher Exact Test*
...
for (data in all_data@stats) {
  EnhancedVolcano(data, lab=gsub("@","->",data$columns_name),x='lodds',y='p',pCutoff=0.05)
