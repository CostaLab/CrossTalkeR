...
genes_table = names(params$obj1@tables)[which(grepl("_x_", names(data@tables)))]

if(("Transcription Factor" %in% data@tables[[genes_table]]$type_gene_A) | ("Transcription Factor" %in% data@tables[[genes_table]]$type_gene_A)){
  PCA_TF_flag <- TRUE
}else {
  PCA_TF_flag <- FALSE
}
