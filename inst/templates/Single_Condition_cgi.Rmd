...
*Here a Principal Component Analysis (PCA) was done using the cell gene interaction topological measures. The high ranked observations (>=2$\sigma$) is labeled and each measure contribuition is placed*
...
*Heatmap of high score genes per measure for each phenotype*
